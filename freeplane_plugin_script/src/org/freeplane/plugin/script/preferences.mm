...
<node TEXT="Script Preferences" ID="ID_776863743"><hook NAME="MapStyle">
    <conditional_styles>
...
<node TEXT="execute_scripts_without_network_restriction" ID="ID_195127580">
<attribute NAME="type" VALUE="boolean"/>
...
<node TEXT="Templates" POSITION="left" ID="ID_457483691" LINK="../../../../../../freeplane/ant/Menu_Prefs_Templates.mm">
<attribute NAME="type" VALUE="--ignore--"/>
</node>
</node>
</map>
