...
class PasteTreeCloneAction extends AFreeplaneAction {
	private static final long serialVersionUID = 1L;

	public PasteTreeCloneAction() {
		super("PasteTreeCloneAction");
	}
	...
	public void actionPerformed(final ActionEvent e) {
		...
		clipboardController.pasteTreeClone(clipboardController.getClipboardContents(), parent, false, parent.isNewChildLeft());
	}
}
