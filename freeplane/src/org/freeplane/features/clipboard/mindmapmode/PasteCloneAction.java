...
class PasteCloneAction extends AFreeplaneAction {
	private static final long serialVersionUID = 1L;

	public PasteCloneAction() {
		super("PasteCloneAction");
	}
	...
	public void actionPerformed(final ActionEvent e) {
		...
		clipboardController.pasteClone(clipboardController.getClipboardContents(), parent, false, parent.isNewChildLeft());
	}
}
